...
class LocalAdapter(var listener: OnItemClickListener.LocalListener) :
    RecyclerView.Adapter<LocalAdapter.ViewHolder>() {

    private var states = emptyList<Local>()
    private var estadoList: ArrayList<Local> = ArrayList()
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(e: Local, listener: OnItemClickListener.LocalListener) = with(itemView) {
        ...
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                if (keyword.isEmpty()) {
                    ...
                    val filteredList = ArrayList<Local>()
                    for (estado: Local in states) {
