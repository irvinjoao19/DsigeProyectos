...
import kotlinx.android.synthetic.main.cardview_tiempo_vida_group.view.*

class TiempoVidaGroupAdapter(var listener: OnItemClickListener.TiempoVidaListener) :
    RecyclerView.Adapter<TiempoVidaGroupAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.cardview_tiempo_vida_group, parent, false)
        return ViewHolder(v)
    }
