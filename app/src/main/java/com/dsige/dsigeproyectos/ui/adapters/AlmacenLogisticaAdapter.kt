...
class AlmacenLogisticaAdapter(var listener: OnItemClickListener.AlmacenLogisticaListener) :
    RecyclerView.Adapter<AlmacenLogisticaAdapter.ViewHolder>() {

    private var states = emptyList<AlmacenLogistica>()
    private var estadoList: ArrayList<AlmacenLogistica> = ArrayList()

    fun addItems(list: List<AlmacenLogistica>) {
        states = list
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(e: AlmacenLogistica, listener: OnItemClickListener.AlmacenLogisticaListener) =
            with(itemView) {
        ...
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                if (keyword.isEmpty()) {
                    ...
                    val filteredList = ArrayList<AlmacenLogistica>()
                    for (estado: AlmacenLogistica in states) {
