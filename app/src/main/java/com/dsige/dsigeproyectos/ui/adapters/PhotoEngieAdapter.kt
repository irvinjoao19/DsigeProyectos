...
class PhotoEngieAdapter(private var listener: OnItemClickListener.RegistroPhotoListener) :
    RecyclerView.Adapter<PhotoEngieAdapter.ViewHolder>() {

    private var photos = emptyList<RegistroPhoto>()

    fun addItems(list: List<RegistroPhoto>) {
        photos = list
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(p: RegistroPhoto, listener: OnItemClickListener.RegistroPhotoListener) =
            with(itemView) {
